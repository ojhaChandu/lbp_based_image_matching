...
image = cv2.imread('/home/chandu/Desktop/img1.pgm')
...
# brick = cv2.imread('/home/chandu/Desktop/img1.pgm')
# brick = cv2.cvtColor(brick, cv2.COLOR_BGR2GRAY)
# grass = cv2.imread('/home/chandu/Desktop/img6.pgm')
# grass = cv2.cvtColor(grass, cv2.COLOR_BGR2GRAY)
# wall = cv2.imread('/home/chandu/Desktop/img8.pgm')
...
filename = []
directory = os.path.join("c:\\","/home/chandu/Desktop/project: forming collage/ukbench")
...
print("type(filename[0])",type(filename[0]))
# print("n:", n )
for i in range(0,len(filename)):
    ...
    if i < len(filename): 
        print(filename)          
        # print("i:", i)
        img1 = cv2.imread("/home/chandu/Desktop/project: forming collage/ukbench/"+filename[i], 0)
        # img1 = cv2.imread((os.path.join(directory+filename[i])),0)
        ...
        for j in range(i+1,len(filename)):
            print("j:", j)
            img2 = cv2.imread("/home/chandu/Desktop/project: forming collage/ukbench/"+filename[j], 0)
            # img2 = cv2.cvtColor(img2, cv2.COLOR_BGR2GRAY)
            _bool_ = match(lbp1, img2)
            if _bool_ == True:
                # print ("entered")
                os.remove("/home/chandu/Desktop/project: forming collage/ukbench/"+filename[j])
                indices.append(j)
